...
public class NumberPickerDialog extends AlertDialog implements OnClickListener {
	...
	public NumberPickerDialog(Context context, int tileId, SHOWMODE showMode,
		...
		mNumberPickerThree = (NumberPicker) view
				.findViewById(R.id.num_picker_three);
		tvUnitOne = (TextView) view.findViewById(R.id.tv_unit_one);
		tvUnitTwo = (TextView) view.findViewById(R.id.tv_unit_two);
	...
	public NumberPickerDialog(Context context, int tileId, SHOWMODE showMode,
		...
		tvUnitOne = (TextView) view.findViewById(R.id.tv_unit_one);
		tvUnitTwo = (TextView) view.findViewById(R.id.tv_unit_two);
		tvUnitThree = (TextView) view.findViewById(R.id.tv_unit_three);
		tvUnitOne.setText(unitOne.length() <= 0 ? "'" : unitOne);// default =
																	// foot
		tvUnitTwo.setText(unitTwo.length() <= 0 ? "''" : unitTwo);// default =
																	// inch
